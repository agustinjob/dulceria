...
public class TicketDevolverTodo extends javax.swing.JFrame {
   ...
   Devoluciones dev;
   Ventana3 ven;
    public TicketDevolverTodo(String idTicket, Devoluciones dev, Ventana3 ven) {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            ti.eliminarVentasDeTicket(idTicket);
            this.dispose();
            ven.llenarCombo();
            dev.dispose();
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(TicketDevolverTodo.class.getName()).log(Level.SEVERE, null, ex);
